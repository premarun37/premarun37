...
- **VLSI Concepts:** Digital VLSI, ASIC Design Flow, RTL Design, Design Verification, Static Timing Analysis (STA), Physical Design  
- **Tools:** Cadence Virtuoso, Xilinx Vivado, LTSpice, EDA Playground, OpenLane, Magic VLSI, Proteus, Keil uVision  
...
- 🔗 **[Li-Fi Audio Transmission System](https://github.com/premarun37/lifi-audio-transmission.git)**  
  Developed a visible light communication (VLC) system to transmit audio wirelessly using LEDs and photodiodes.
...
- 🔗 **[Automatic Gate Control for Smart Parking System](https://github.com/premarun37/automatic-gate-control-for-smart-parking-system.git)**  
  Designed a sensor-driven automated gate system optimized for smart parking applications.
...
## 🌐 Portfolio
🔗 [premarun37.github.io/portfolio](https://premarun37.github.io/portfolio/)
